...
const OfficeVisual = memo(() => (
  <div className="relative h-20 w-full my-3 border border-dashed border-gray-200 rounded-xl flex items-center justify-center bg-gray-50/50 group-hover:bg-white transition-colors overflow-hidden">
    ...
    <span className="absolute bottom-2 left-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-white/50 px-2 py-0.5 rounded-full backdrop-blur-sm">Productivity</span>
  </div>
));
...
const TwinVisual3D = memo(() => (
  <div className="relative h-20 w-full my-3 perspective-1000">
    <motion.div
      className="relative h-full w-full rounded-xl flex items-center justify-center bg-gray-50 shadow-lg border border-gray-200 overflow-hidden"
      whileHover={{ rotateY: 15, rotateX: -10, scale: 1.05 }}
      transition={{ type: "spring", stiffness: 100, damping: 10 }}
    >
      <motion.div
        className="w-16 h-16 bg-white rounded-lg shadow-xl border border-gray-200 p-2 flex items-center justify-center"
        animate={{ rotateY: [0, 360] }}
        transition={{ duration: 10, repeat: Infinity, ease: "linear" }}
      >
        <DiHtml53dEffects className="w-10 h-10 text-black" />
      </motion.div>

      <MousePointer2 className="absolute -bottom-4 -right-4 w-5 h-5 drop-shadow-md text-black" />
      <div className="absolute inset-0 bg-gradient-to-t from-white/60 to-transparent pointer-events-none" />
      <span className="absolute bottom-2 left-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-white/50 px-2 py-0.5 rounded-full backdrop-blur-sm">
        3D Magician
      </span>
    </motion.div>
  </div>
...
const FigmaVisual = memo(() => (
  <div className="relative h-24 w-full my-3 border border-dashed border-gray-200 rounded-xl flex items-center justify-center bg-gray-50/50 group-hover:bg-white transition-colors overflow-hidden">
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-white/60 to-transparent pointer-events-none" />
    <span className="absolute bottom-2 left-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-white/50 px-2 py-0.5 rounded-full backdrop-blur-sm">Engineering design</span>
  </div>
));
...
const FramerVisual = memo(() => (
  <div className="relative h-24 w-full my-3 border border-dashed border-gray-200 rounded-xl flex items-center justify-center bg-gray-50/50 group-hover:bg-white transition-colors overflow-hidden">
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-white/60 to-transparent pointer-events-none" />
    <span className="absolute bottom-2 left-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-white/50 px-2 py-0.5 rounded-full backdrop-blur-sm">Building Information Modeling</span>
  </div>
));
...
const MaxVisual3D = memo(() => (
  <div className="relative h-24 w-full my-3 border border-dashed border-gray-200 rounded-xl flex items-center justify-center bg-gray-50/50 group-hover:bg-white transition-colors overflow-hidden perspective-800">
    <motion.div
    ...
    >
      {[0, 1, 2, 3].map((i) => (
        <motion.div
          key={i}
          className="w-8 h-8 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full shadow-lg"
          animate={{
            scale: [1, 1.5, 1],
            y: [0, -10, 0],
            rotateX: [0, 180, 0],
...
const IllustratorVisual = memo(() => (
  <div className="relative h-24 w-full my-3 border border-gray-100 rounded-xl overflow-hidden bg-gray-50 group-hover:border-gray-200 transition-colors">
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-white/60 to-transparent pointer-events-none" />
    <span className="absolute bottom-2 left-3 text-[10px] font-bold text-gray-500 uppercase tracking-widest bg-white/80 px-2 py-0.5 rounded-full backdrop-blur-sm z-10 shadow-sm">Image Editing</span>
  </div>
));
    ...
    <div className="w-full min-h-full flex flex-col items-center p-4 md:p-6 lg:p-8 overflow-visible pb-20">
      ...
      <div className="w-full max-w-[1200px] grid grid-cols-1 md:grid-cols-3 gap-5 items-stretch">
        <Card className="justify-between" index={0}>
          <div>
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="px-2 py-1 bg-red-50 rounded-md border border-red-100">
                <span className="text-[10px] font-bold text-red-600 uppercase tracking-wide">Drafting</span>
              </div>
            </div>
        ...
        <Card className="justify-between" index={1}>
          <div>
            <div className="flex justify-between items-start mb-3">
              <div className="w-12 h-12 bg-[#1f70ff] rounded-xl flex items-center justify-center border border-gray-100   group-hover:scale-105 transition-all">
                <h2 className='text-3xl font-bold text-white '>R</h2>
              </div>
              <div className="px-2 py-1 bg-blue-50 rounded-md border border-blue-100">
                <span className="text-[10px] font-bold text-blue-600 uppercase tracking-wide">BIM</span>
              </div>
            </div>
        ...
        <Card className="justify-between" index={2}>
          <div>
            <div className="flex justify-between items-start mb-3">
              ...
              <div className="px-2 py-1 bg-blue-50 rounded-md border border-blue-100">
                <span className="text-[10px] font-bold text-blue-600 uppercase tracking-wide">Image Editing</span>
              </div>
            </div>
          ...
          <div>
            <div className="flex justify-between items-start mb-3">
              <div className="w-12 h-12 bg-gray-200 rounded-xl flex items-center justify-center border border-gray-100   group-hover:scale-105 transition-all">
                <h2 className='text-3xl font-bold text-[#39a5cc] '>3D</h2>
              </div>
              <div className="px-2 py-1 bg-blue-50 rounded-md border border-blue-100">
                <span className="text-[10px] font-bold text-blue-600 uppercase tracking-wide">3D Modeling</span>
              </div>
            </div>
          ...
          <div>
            <div className="flex justify-between items-start mb-3">
              <div className="w-12 h-12 bg-black rounded-xl flex items-center justify-center border border-gray-100   group-hover:scale-105 transition-all">
                <h2 className='text-3xl font-bold text-white '>T</h2>
              </div>
              <div className="px-2 py-1 bg-black rounded-md border border-gray-100">
                <span className="text-[10px] font-bold text-white uppercase tracking-wide">Visualization</span>
              </div>
            </div>
          ...
          <SkillMeter percentage={80} color="bg-black" />
        </Card>
                               <Card className="justify-between" index={1}>
          <div>
            <div className="flex justify-between items-start mb-3">
              <div className="w-12 h-12 bg-[#e0530c] rounded-xl flex items-center justify-center border border-gray-100   group-hover:scale-105 transition-all">
                <h2 className='text-3xl font-bold text-white '>O</h2>
              </div>
                              <div className="px-2 py-1 bg-orange-50 rounded-md border border-orange-100">
                <span className="text-[10px] font-bold text-orange-600 uppercase tracking-wide">Productivity</span>
              </div>
            </div>
